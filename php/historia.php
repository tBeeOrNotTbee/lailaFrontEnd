        ...
        <main class="page-content ml--100 ml_lg--0 ml_md--0 ml_sm--0">
            ...
            <div class="container-fluid">
                ...
                <div  class="row justify-content-center">
                  <h1 id="historiaTitulo" class="col-6 col-lg-8 smooth-stone grey w100 text-center my-3">
                    #nuestrahistoria
                  </h1>
                </div>
                <div class="row history justify-content-center">
                  <h2 id="sloganHistoria" class="monserrat-bold mx-auto px-2"><span>Amor por lo que hacemos.</span></h2>
                </div>
                <section class="row">
                  <p id="history-P"class="p-3 col-11  monserrat history-fontcolor"><b class="black"> LAILA FRANK</b> nace en el año 2012, concebida como marca con sello de autor:
